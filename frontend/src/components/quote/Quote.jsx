...
const Quote = ({ close }) => {
  ...
  return (
    <>
      <div className="z-106 relative bg-white ">
        <img
          className="z-106 max-w-full h-full object-cover object-center"
          src="https://media.kvilr.com/wp-content/uploads/2024/02/Global.jpg"
          alt="slide"
        />
            ...
            <form className="z-107 relative bg-white px-6 py-8 rounded shadow-md text-black w-full  ">
              ...
              <div class="">
                <select className="block border border-grey-light w-full p-2 rounded mb-1 text-[12px]  lg:p-3 lg:mb-4">
                  ...
                  <option
                    value="Croatia (Local Name: Hrvatska)"
                    data-concent="2"
                  >
